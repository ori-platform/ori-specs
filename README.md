...
| Evidence chain | [evidence/v2.md](evidence/v2.md) | `draft` | producer (runtime) `shipped` in v2.5.0-rc.3, `unassessed`, verifier (evidence-authority) `implemented-unreleased`, `unassessed` | `frozen` (2026-08-25), audit `pending` |
...
| Evidence exchange (off-site delivery) | [evidence-exchange/v1.md](evidence-exchange/v1.md) | `draft` | producer (runtime) `shipped` in v2.5.0-rc.3, `unassessed`, consumer (runtime) `shipped` in v2.5.0-rc.3, `unassessed`, gateway `implemented-unreleased`, claimed, `unassessed`, authority (evidence-authority) `implemented-unreleased`, `unassessed` | `frozen` (2026-08-25), audit `pending` |
| Evidence Transport | [evidence-transport/v1.md](evidence-transport/v1.md) | `draft` | authority (evidence-authority) `implemented-unreleased`, `non-conforming` at assessed current snapshot `146a462` (1 divergence), gateway `implemented-unreleased`, claimed, `unassessed` | `frozen` (2026-08-25), audit `pending` |
...
| Runtime evidence anchor | [runtime-evidence-anchor/v1.md](runtime-evidence-anchor/v1.md) | `draft` | producer (runtime) `shipped` in v2.5.0-rc.3, claimed, `unassessed`, verifier (evidence-authority) `implemented-unreleased`, `unassessed` | `frozen` (2026-08-23), audit `pending` |
...
| Runtime health socket RPC | [runtime-health/v2.md](runtime-health/v2.md) | `draft` | producer (runtime) `shipped` in v2.5.0-rc.3, `non-conforming` at assessed current snapshot `d2aba48` (2 divergences), cli `implemented-unreleased`, `unassessed` | `frozen` (2026-08-25), audit `pending` |
...
| Skill signing contract | [signing/v1.md](signing/v1.md) | `draft` | verifier (runtime) `shipped` in v1.0.0, `unassessed`, issuer (skills-hub) `implemented-unreleased`, `unassessed`, verifier (sdk-python) `implemented-unreleased`, `unassessed` | `frozen` (2026-06-12), audit `pending` |
