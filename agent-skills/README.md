...
| --- | --- | --- |
| `ori-rigorous-review` | 1.3.1 | Evidence-first, safety-aware review for merge decisions, design reviews, defect verification, and roadmap research. The adversarial pass, the briefing and handoff that surround it, the report template, and the physical-authority rules load on demand from `references/`. |
