...
> Status: maturity `draft`; compatibility `frozen` by a conservative baseline
> determination (gateway `a2e462d`, 2026-06-09), baseline audit `pending`;
> adoption: gateway `implemented-unreleased`, `unassessed`; proof: end-to-end
> `none`, HIL `none`, production `none`. Record:
> [status/gateway-config/v1.json](../status/gateway-config/v1.json).
>
